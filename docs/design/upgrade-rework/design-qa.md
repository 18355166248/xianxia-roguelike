...
- 目标稿：`selected-battlefield-cultivation.png`（853×1844）
- 最终实机：`implementation-battlefield-cultivation-final.png`（1280×720，内嵌 393×679 游戏视口）
- 首悟道种：`implementation-seed-choice-final.png`
- 同屏比较：`battlefield-cultivation-comparison-final.png`
...
- iPhone 14 Pro 实机截图：`hud-bonus-detail-final.png`。
