...
export const UPGRADES: UpgradeConfig[] = [
    {
        ...
        path: 'edge',
        role: '飞剑增殖',
        descriptions: ['觉醒自动御剑', '飞剑增至 2 柄', '飞剑增至 3 柄，命中后折返追击'],
        maxLevel: 3,
        accent: '#7DD3FC',
    ...
    },
    {
        ...
        path: 'edge',
        role: '单击强化',
        descriptions: ['飞剑伤害 +30%', '飞剑伤害再 +30%', '飞剑伤害再 +35%，命中刻下剑痕叠伤'],
        maxLevel: 3,
        accent: '#FDE68A',
    ...
    },
    {
        ...
        path: 'mystic',
        role: '机动免伤',
        descriptions: ['解锁踏云闪身与短暂无敌', '闪身距离与无敌时间提升', '沿途斩击敌人，移动起步免碰撞'],
        maxLevel: 3,
        accent: '#86EFAC',
    ...
    },
    {
        ...
        path: 'mystic',
        role: '蓄力爆发',
        descriptions: ['解锁蓄力天劫', '天劫降下两重剑光', '三重天劫，命中刻下雷印引爆'],
        maxLevel: 3,
        accent: '#FDE68A',
        iconResourcePath: 'art/relics/xianxia-relics_15/spriteFrame',
    },
    {
        id: 'guard',
        title: '护体罡气',
        path: 'vitality',
        role: '气血上限',
        descriptions: ['生命上限 +25 并回复', '生命上限再 +30 并回复', '生命上限再 +35，护体耗尽时爆发剑气'],
        maxLevel: 3,
        accent: '#93C5FD',
    ...
    },
    {
        ...
        path: 'vitality',
        role: '击杀续航',
        descriptions: ['击杀回复 2 点气血', '击杀回复 3 点气血', '击杀回复 5 点，溢出转为护体'],
        maxLevel: 3,
        accent: '#82D7AC',
        iconResourcePath: 'art/relics/xianxia-relics_18/spriteFrame',
    },
];
